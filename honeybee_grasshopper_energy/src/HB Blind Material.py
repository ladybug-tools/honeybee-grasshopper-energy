...
-
    ...
    Args:
        ...
        _slat_width_: The width of slat measured from edge to edge [m].
            Default: 0.025 m (25 mm).
        _slat_separation_: The distance between each of the slats [m].
            Default: 0.01875 m (18.75 mm).
        _slat_thickness_: A number between 0 and 0.1 for the thickness of the slat [m].
        ...
        _reflectance_: Number between 0 and 1 for the reflectance of solar
            ...
            Default: 0.5, which is typical of a painted white blind.
        _t_infrared_: Long-wave hemisperical transmittance of the blind material.
            Default: 0.
