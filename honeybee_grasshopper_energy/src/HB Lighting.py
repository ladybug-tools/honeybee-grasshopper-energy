...
-
    ...
    Args:
        _name_: Text string for the lighting definition name. If None, a unique
...
if all_required_inputs(ghenv.Component):
    ...
    if _name_ is None:
        _name_ = "Lighting_{}".format(uuid.uuid4())
    ...
    lighting = Lighting(_name_, _watts_per_area, _schedule,
