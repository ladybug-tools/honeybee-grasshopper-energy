...
-
    ...
    Args:
        _hb_obj: Honeybee Shades, Apertures, Faces, or Rooms to which the input
            ...
            this component.
        _constr: A Honeybee ShadeConstruction to be applied to the input _hb_obj.
...
if all_required_inputs(ghenv.Component):
    ...
    error_msg = 'Input _hb_obj must be a Room, Face, Aperture, or Shade. Not {}.'
